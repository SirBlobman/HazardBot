...
public class CommandPing extends ICommand {
    ...
    public void run(MessageAuthor ma, TextChannel tc, String[] args) {
        ...
        EmbedBuilder eb1 = new EmbedBuilder().setTitle("Please Wait").setDescription("Pinging...")
        ...
        fsent.whenComplete((sent, error) -> {
            ...
            EmbedBuilder eb2 = new EmbedBuilder().setTitle("Pong!").setDescription("Took " + time3 + " ms.")
                    .setColor(Color.BLUE);
            sent.delete();
            tc.sendMessage(eb2);
        });
