...
import xyz.hazardbot.utility.yaml.MemoryConfigurationOptions;
...
public class FileConfigurationOptions extends MemoryConfigurationOptions {
     ...
     * <p/>
     * If this is true, if a default {@link FileConfiguration} is passed to then
     * upon saving it will use the header from that config, instead of the one
     * provided here.
     * <p/>
