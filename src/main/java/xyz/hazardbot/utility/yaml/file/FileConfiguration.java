...
public abstract class FileConfiguration extends MemoryConfiguration {
    ...
    /**
     * Creates an empty {@link xyz.hazardbot.utility.yaml.file.FileConfiguration}
    ...
    /**
     * Creates an empty {@link xyz.hazardbot.utility.yaml.file.FileConfiguration}
     * using the specified {@link Configuration} as a source for all default values.
     *
    ...
    /**
     * Saves this {@link xyz.hazardbot.utility.yaml.file.FileConfiguration} to the
     * specified location.
     * <p/>
     ...
     * @throws                          java.io.IOException Thrown when the given
     *                                  file cannot be written to for any reason.
    ...
    /**
     * Saves this {@link xyz.hazardbot.utility.yaml.file.FileConfiguration} to a
    ...
    /**
     * Loads this {@link xyz.hazardbot.utility.yaml.file.FileConfiguration} from the
     * specified location.
     * <p/>
     ...
     * {@link java.nio.charset.Charset#defaultCharset()} for files, unless
     * {@link #UTF8_OVERRIDE} but not {@link #UTF_BIG} is specified.
     *
     * @param file File to load from.
     * @throws                               java.io.FileNotFoundException Thrown
     *                                       when the given file cannot be opened.
     * @throws                               java.io.IOException Thrown when the
     ...
     * <p/>
     * This will attempt to use the
     * {@link java.nio.charset.Charset#defaultCharset()}, unless
     ...
     * @throws                               java.io.IOException thrown when
     *                                       underlying reader throws an IOException
    ...
    /**
     * Loads this {@link xyz.hazardbot.utility.yaml.file.FileConfiguration} from the
     * specified string, as opposed to from file.
     * <p/>
     * All the values contained within this configuration will be removed, leaving
     * only settings and defaults, and the new values will be loaded from the given
     * string.
     ...
     * {@link xyz.hazardbot.utility.yaml.file.FileConfiguration} and returns the
     * result.
     * <p/>
